  ...
  return (
    <section className="relative h-screen min-h-[700px] w-full overflow-hidden">
      <motion.div style={{ y: imgY }} className="absolute inset-0 -top-24 -bottom-24">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-ivory/60 via-ivory/30 to-ivory/85" />
        <div className="absolute inset-0 bg-gradient-to-r from-ivory/40 via-transparent to-transparent" />
      </motion.div>

      <motion.div style={{ y, opacity }} className="relative z-10 flex h-full flex-col justify-center px-6">
        <div className="mx-auto max-w-5xl text-center">
          <p className="eyebrow mb-6">Akshaya Dental Hospital · Hyderabad</p>
          <h1 className="font-serif text-[clamp(2.75rem,7vw,6.5rem)] leading-[1.02] text-charcoal">
            Your Smile,
            <br />
            <span className="italic text-sage-dark">Our Passion.</span>
          </h1>
          <p className="mx-auto mt-8 max-w-xl text-lg text-charcoal/70 leading-relaxed">
            Boutique family dentistry led by {CLINIC.doctor} — calm rooms, transparent
            care, and explanations you can actually follow.
          </p>
